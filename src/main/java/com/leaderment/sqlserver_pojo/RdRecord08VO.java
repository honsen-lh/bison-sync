...
public class RdRecord08VO {
	...
	public String toString() {
		return "RdRecord08VO [id=" + id + ", brdflag=" + brdflag + ", cvouchtype=" + cvouchtype + ", cbustype="
				...
				+ ", cmodifyperson=" + cmodifyperson + ", dmodifydate=" + dmodifydate + ", dnmaketime=" + dnmaketime
				+ ", dnmodifytime=" + dnmodifytime + ", dnverifytime=" + dnverifytime + ", cpzid=" + cpzid
