...
public class RdRecord01VO {
	...
	public String toString() {
		return "RdRecord01VO [id=" + id + ", brdflag=" + brdflag + ", cvouchtype=" + cvouchtype + ", cbustype="
				+ cbustype + ", csource=" + csource + ", cwhcode=" + cwhcode + ", ddate=" + ddate + ", ccode=" + ccode
				+ ", crdcode=" + crdcode + ", cdepcode=" + cdepcode + ", cptcode=" + cptcode + ", cvencode=" + cvencode
				+ ", cordercode=" + cordercode + ", carvcode=" + carvcode + ", chandler=" + chandler + ", cmemo="
				+ cmemo + ", btransflag=" + btransflag + ", cmaker=" + cmaker + ", cdefine1=" + cdefine1 + ", cdefine2="
				+ cdefine2 + ", dveridate=" + dveridate + ", darvdate=" + darvdate + ", vtid=" + vtid
				+ ", ipurarriveid=" + ipurarriveid + ", itaxrate=" + itaxrate + ", iexchrate=" + iexchrate
				+ ", cexchname=" + cexchname + ", cmodifyperson=" + cmodifyperson + ", dmodifydate=" + dmodifydate
				+ ", dnmaketime=" + dnmaketime + ", dnmodifytime=" + dnmodifytime + ", dnverifytime=" + dnverifytime
				+ ", cvenpuomprotocol=" + cvenpuomprotocol + ", dcreditstart=" + dcreditstart + ", icreditperiod="
				+ icreditperiod + ", dgatheringdate=" + dgatheringdate + ", bcredit=" + bcredit + ", cpzid=" + cpzid
				+ ", csysbarcode=" + csysbarcode + ", cchecksignflag=" + cchecksignflag + "]";
	}
