...
public class rdrecords09 {
    ...
    public String getCbsourcecodels() {
        return cbsourcecodels;
    }

    public void setCbsourcecodels(String cbsourcecodels) {
        this.cbsourcecodels = cbsourcecodels == null ? null : cbsourcecodels.trim();
    }
    ...
    public Integer getIdebitchildids() {
        return idebitchildids;
    }

    public void setIdebitchildids(Integer idebitchildids) {
    ...
    public BigDecimal getIpickedquantity() {
        return ipickedquantity;
    }

    public void setIpickedquantity(BigDecimal ipickedquantity) {
        this.ipickedquantity = ipickedquantity;
    }

    public BigDecimal getIpickednum() {
        return ipickednum;
    }

    public void setIpickednum(BigDecimal ipickednum) {
        this.ipickednum = ipickednum;
    }

    public Integer getIcrmvouchids() {
        return icrmvouchids;
    }

    public void setIcrmvouchids(Integer icrmvouchids) {
        this.icrmvouchids = icrmvouchids;
    }

    public String getCcrmvouchcode() {
        return ccrmvouchcode;
    }

    public void setCcrmvouchcode(String ccrmvouchcode) {
        this.ccrmvouchcode = ccrmvouchcode == null ? null : ccrmvouchcode.trim();
    }
    ...
    public Integer getIsrcvouchids() {
        return isrcvouchids;
    }

    public void setIsrcvouchids(Integer isrcvouchids) {
        this.isrcvouchids = isrcvouchids;
    }
