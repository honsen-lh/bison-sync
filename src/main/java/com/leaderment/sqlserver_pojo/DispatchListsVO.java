...
public class DispatchListsVO {
    ...
    public Integer getIcorid() {
        return icorid;
    }

    public void setIcorid(Integer icorid) {
        this.icorid = icorid;
    }
    ...
    public BigDecimal getIsettlenum() {
        return isettlenum;
    }

    public void setIsettlenum(BigDecimal isettlenum) {
        this.isettlenum = isettlenum;
    }

    public BigDecimal getIsettlequantity() {
        return isettlequantity;
    }

    public void setIsettlequantity(BigDecimal isettlequantity) {
    ...
    public BigDecimal getFsumsignquantity() {
        return fsumsignquantity;
    }

    public void setFsumsignquantity(BigDecimal fsumsignquantity) {
        this.fsumsignquantity = fsumsignquantity;
    }

    public BigDecimal getFsumsignnum() {
        return fsumsignnum;
    }

    public void setFsumsignnum(BigDecimal fsumsignnum) {
    ...
    public BigDecimal getFlossrate() {
        return flossrate;
    }

    public void setFlossrate(BigDecimal flossrate) {
        this.flossrate = flossrate;
    }

    public BigDecimal getFrlossqty() {
        return frlossqty;
    }

    public void setFrlossqty(BigDecimal frlossqty) {
        this.frlossqty = frlossqty;
    }

    public BigDecimal getFveribillqty() {
        return fveribillqty;
    }

    public void setFveribillqty(BigDecimal fveribillqty) {
        this.fveribillqty = fveribillqty;
    }

    public BigDecimal getFveribillsum() {
        return fveribillsum;
    }

    public void setFveribillsum(BigDecimal fveribillsum) {
    ...
    public String toString() {
        return "DispatchListsVO{" +
                ...
                ", inattax=" + inattax +
                ", inatsum=" + inatsum +
                ", inatdiscount=" + inatdiscount +
                ", isettlenum=" + isettlenum +
                ", isettlequantity=" + isettlequantity +
                ", ibatch=" + ibatch +
                ", cbatch='" + cbatch + '\'' +
                ", bsettleall=" + bsettleall +
                ", itb=" + itb +
                ...
                ", cdefine23='" + cdefine23 + '\'' +
                ", cdefine24='" + cdefine24 + '\'' +
                ", foutquantity=" + foutquantity +
                ", foutnum=" + foutnum +
                ", csocode='" + csocode + '\'' +
                ", bqaneedcheck=" + bqaneedcheck +
                ", bqaurgency=" + bqaurgency +
                ", bqachecking=" + bqachecking +
                ", bqachecked=" + bqachecked +
                ", fsumsignquantity=" + fsumsignquantity +
                ", fsumsignnum=" + fsumsignnum +
                ", bcosting=" + bcosting +
                ", cordercode='" + cordercode + '\'' +
                ", iorderrowno=" + iorderrowno +
                ", iexchsum=" + iexchsum +
                ", irowno=" + irowno +
                ", bneedsign=" + bneedsign +
                ", bsignover=" + bsignover +
                ...
                ", flossrate=" + flossrate +
                ", frlossqty=" + frlossqty +
                ", fveribillqty=" + fveribillqty +
                ", fveribillsum=" + fveribillsum +
                ", isaleoutid=" + isaleoutid +
                ", bsaleprice=" + bsaleprice +
                ", bgift=" + bgift +
                ", bmpforderclosed=" + bmpforderclosed +
                ", cbsysbarcode='" + cbsysbarcode + '\'' +
                ", biacreatebill=" + biacreatebill +
                '}';
    }
}
