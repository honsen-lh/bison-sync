...
public class RdRecord09 {
    ...
    public String getCtransflag() {
        return ctransflag;
    }

    public void setCtransflag(String ctransflag) {
        this.ctransflag = ctransflag == null ? null : ctransflag.trim();
    }
    ...
    public void setCsyssource(String csyssource) {
        this.csyssource = csyssource == null ? null : csyssource.trim();
    }
    ...
    public void setCsyssourceid(String csyssourceid) {
        this.csyssourceid = csyssourceid == null ? null : csyssourceid.trim();
    }
